...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/* 
* This is one of two Dijkstra shortest path finder classes. Both work with reasonable speed and can be used.
* Uses classes DemoEdge (Link), DemoGraph (Network), DemoVertex (Node)
*/
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
//		Log.write("ShortestPath NodeList = "+nodePathId.toString());
	...
	// Test section with virtual network:
	...
	public static void calculate(DemoVertex source){
		...
		// - Update the distances for all the neighbors (in the priority queue). Repeat the process till all the connected nodes are visited.
