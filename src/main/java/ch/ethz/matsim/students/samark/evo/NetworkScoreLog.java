...
// this class is a short version of the CBP parameter class CBPII and used in parallel for some most important scores.
// however, the class is not essential and was used rather at the beginning of the developement
// it is recommended not to mind or use it and work with CBPII only
