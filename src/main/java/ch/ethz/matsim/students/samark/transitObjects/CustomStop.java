package ch.ethz.matsim.students.samark.transitObjects;
...
import org.matsim.pt.transitSchedule.api.TransitStopFacility;
 public class CustomStop {
	...
	// The linkList collects all these linkIDs which refer to one stopFacility
	 ...
	 public boolean addedToNewSchedule;	// decides whether an original stop has already been built into the new metro network --> and schedule
	 public boolean used;				// if the stop has been used on an actual route, not just a potential metro stop
