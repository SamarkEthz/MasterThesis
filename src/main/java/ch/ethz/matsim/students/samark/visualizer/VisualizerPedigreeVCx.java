...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/* 
* This class is intended to display the evolution of entire networks
* Each network carries information of its parent(s), which can be used to run an entire blood line
*/
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
public class VisualizerPedigreeVCx {
	...
	// %%% --- %% --- %% --- %% --- %% --- %% --- %% --- %% --- DISPLAY EVOLUTION OF NETWORKS---%%---%%---%%---%%---%%---%%---%%---%%---%%---%%%
		...
		// Prepare background image, which is the VirtualCity network without metro lines
		...
		// conversion (shift and scale) between the pixel COS and the actual COS of the network
		...
		// shift is custom addition by 'samark during development and not needed for default pedigree visualization
...
//				g.setColor(new Color(187, 0, 0));				
				...
				// 		}
				// }
				// Load the MRoute files of the network to draw its individual links onto the network image
				...
				if (routesNetworkFile.exists()) {
					...
					// draw every link of the metro routes onto the BG image
	...
	//				Log.write("CAUTION: Network routes file does not exist! Jumping to its parent.");
				...
				if (gen > firstGeneration && gen-2-pedigreeShift >=0) {
					// do this loop to update the network (parent) which shall be displayed in generation prior to this one.
