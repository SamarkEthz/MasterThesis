...
// Methods to manipulate network objects
public class NetworkOperators {

	public NetworkOperators() {
	}

	// add all nodes and links from one network to another... the "to"-network is returned at the end
	...
	public static Network superimpose2separateNetwork(Network network1, Set<String> transportModes1, Network network2, Set<String> transportModes2, String fileName) {
		...
		// do this by creating an all new empty network and copying both networks to the new one, which will eventually be returned
	...
	// build a MATSim network from the links featured in an array of networkRoutes
