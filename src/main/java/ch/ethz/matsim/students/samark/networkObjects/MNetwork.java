...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/* 
* This class is an elaborate version of the MATSIM network
* It contains all its MRoutes within a routesMap that make up the entire MNetwork
*/
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
//		this.calculateTotalRouteLengthAndDrivenKM();
		...
		// go through all MRoutes and add up totals in lengths, vehicles and stations
		for (MRoute mr : this.routeMap.values()) {
...
//		Log.write("overallOGpercentage Network="+overallOGlength/this.totalRouteLength);
	...
	// performs the welfare calculation
	// REFER TO THE THESIS FOR DETAILS AND THE DERIVATION OF THE WELFARE FUNCTION
	public double performCostBenefitAnalysisNetwork(double lifeTime, double populationFactor, CBPII refCase, CBPII newCase,
		...
		// calculate the different lengths according to their nature (UG/OG; new/develop/equip) to get costs for each of them individually
		...
		// load the (cost) parameters specified in NetworkEvolution/VCEvolution
...
//		//	);
		...
		if (utilityFunctionSelection.equals("1")) {	// New Module LEAN
			...
			double discountFactor = 1.02;	// discount factor according to SWISS Norm 641820 and ff.
