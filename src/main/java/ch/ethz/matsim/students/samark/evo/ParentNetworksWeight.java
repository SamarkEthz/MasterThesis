...
public class ParentNetworksWeight {
	...
	public ParentNetworksWeight() {
		child1.put(1, 0.0);	// weight of parent1 in child1
		child1.put(2, 0.0);	// weight of parent2 in child1
		child2.put(1, 0.0);	// weight of parent1 in child2
		child2.put(2, 0.0);	// weight of parent2 in child2
	}
