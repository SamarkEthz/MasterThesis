...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/* 
 * This class is intended for testing and demonstrating code snippets and and methods
 * It does not contribute to the actual framework and is isolated.
 */
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
public class Demo {
	...
	public static void main(String[] args) throws IOException, XMLStreamException, URISyntaxException {
		...
		int lastGen = Integer.parseInt(args[1]);
		List<Map<String, String>> pedigreeTree = new ArrayList<Map<String, String>>();
		File pedigreeTreeFile = new File(simFolder+"/zurich_1pm/Evolution/Population/HistoryLog/pedigreeTree.xml");
		pedigreeTree.addAll(XMLOps.readFromFile(pedigreeTree.getClass(), pedigreeTreeFile.toString()));
		XMLOps.writeToFile(pedigreeTree, simFolder+"/zurich_1pm/Evolution/Population/HistoryLog/pedigreeTreeBackup.xml");
		if (pedigreeTree.size() < lastGen-1) {
			System.out.println(pedigreeTree.size());
			int genDiff = lastGen-1-pedigreeTree.size();
		...
		XMLOps.writeToFile(pedigreeTree, simFolder+"/zurich_1pm/Evolution/Population/HistoryLog/pedigreeTree.xml");
		System.out.println(pedigreeTree.size());
		
//		List<Map<String,String>> gens = new ArrayList<Map<String,String>>();
//		List<Map<String,String>> gensX = new ArrayList<Map<String,String>>();
//		
//		gens.addAll(XMLOps.readFromFile(gens.getClass(), "Results/37/4en/PedigreeTree.xml"));
//		gensX.addAll(XMLOps.readFromFile(gensX.getClass(), "Results/37/4en/PedigreeTreeOldBeforeRecall.xml"));
//		
//		Map<String,String> defaultMap = new HashMap<String,String>();
//
//		for (int g=1; g<=16; g++) {
...
//		
//		for (int g=0; g<26; g++) {
//			gens.add(0, defaultMap);
//		}
//		
//		for (int g = 0; g<gens.size(); g++) {
//			System.out.println(g);
//			System.out.println(gens.get(g).get("Network5"));
//			System.out.println(gensX.get(g).get("Network5"));
//			System.out.println(gensX.size());
//		}
