...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/* 
* This class holds all parameters for the cost benefit calculations (CBP=CostBenefitParameter).
* The parameters result from processing the simulation output and extracting the key indicators as well as scanning
* the infrastructure to assess its construction and operational costs. The parameter are mostly self-explanatory and explained in comments if required.
* Note that several empty parameters are stored in every CBPII as placeholders.
* This way, the class itself can be kept as is and older and never files are compatible.
*/
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
public class CBPII{
	...
	public double carTimeTotal = 0.0;			// [sec/day]
	public double carPersonDist = 0.0;			// [m]
	public double ptTimeTotal = 0.0;			// [sec/day]
	public double ptPersonDist = 0.0;			// [m]
	public double averagePtTime = 0.0;			// [sec/day*person]
	public double averageCartime = 0.0;			// [sec/day*person]
	public double metroPersonDist = 0.0;		// [m]
	public double totalTravelTime = 0.0;		// [sec/day]
	public double constCost = 0.0;				// [CHF/year]
	public double opsCost = 0.0; 				// [CHF/year]
	public double mrCost = 0.0;					// [CHF/year]
	public double travelUtil = 0.0;				// [CHF/year]
	public double extCostSavings = 0.0;			// [CHF/year]
	public double totalAnnualCost = 0.0;		// [CHF/year]
	public double totalAnnualBenefit = 0.0;		// [CHF/year]
	
	// if needed in future:
	public double rollingStockCost = 0.0;		// [CHF/year]
	public double landCost = 0.0;				// [CHF/year]
	public double externalCost = 0.0;			// [CHF/year]
	public double ptPassengerCost = 0.0;		// [CHF/year]
	public double travelTimeGainsCar = 0.0;		// [CHF/year]
	public double travelTimeGainsPt = 0.0;		// [CHF/year]
	public double travelTotalUtilGainsPt = 0.0;	// [CHF/year]
	public double travelTimeGains = 0.0;		// [s]
	public double ptVatIncrease = 0.0;			// [CHF/year]
	public double customVariable1 = 0.0;		// other travel TIME 		= WALK/BIKE (not car/pt) in [s]
	public double customVariable2 = 0.0;		// other travel TIME GAINS  = WALK/BIKE (not car/pt) in [CHF/year]
	public double customVariable3 = 0.0;		// ptDisutilityEquivalentTimeTotal in [s]
	public double customVariable4 = 0.0;		// vehicleSavings in [CHF/year]
	public double customVariable5 = 0.0;		// not used yet - placeholder
	public double customVariable6 = 0.0;		// not used yet - placeholder
	public double customVariable7 = 0.0;		// not used yet - placeholder
	public double customVariable8 = 0.0;		// not used yet - placeholder
	public double customVariable9 = 0.0;		// not used yet - placeholder
	public double customVariable10 = 0.0;		// not used yet - placeholder
	...
	public void calculateBenefits(CBPII refCase) throws FileNotFoundException {
		...
		// all cost benefit calculations conform to the ones and the detailed description in networkObjects.MNetwork.performCostBenefitAnalysisNetwork
