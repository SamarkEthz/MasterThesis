...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/* 
* This class is used to calculate and plot different standard (and other) deviations
* of the simulation output along consecutive MATSim iterations
* --> This is a measure of the stability of the simulations
*/
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
//	java -Xmx10G -cp samark-0.0.1-SNAPSHOT.jar ch.ethz.matsim.students.samark.visualizer.VisualizerStdDev2 1pct 200 40 30
	...
	public static void main(String[] args) throws IOException {
		...
		List<Double> carUsers = new ArrayList<Double>();		// car mode percentage of the total mode share
		List<Double> ptUsers = new ArrayList<Double>();			// car mode percentage of the total mode share
		List<Double> otherUsers = new ArrayList<Double>();		// car mode percentage of the total mode share
		List<Double> carTimeDelta = new ArrayList<Double>();	// deviation of this iteration's average car travel times from avergae over all iterations
		List<Double> ptTimeDelta = new ArrayList<Double>();		// deviation of this iteration's average pt travel times from avergae over all iterations
		List<Double> otherTimeDelta = new ArrayList<Double>();	// deviation of this iteration's average walk/bike travel times from avergae over all iterations
		List<Double> carTime = new ArrayList<Double>();			// average total daily car travel times
		List<Double> ptTime = new ArrayList<Double>();			// average total daily pt travel times
		List<Double> otherTime = new ArrayList<Double>();		// average total daily walk/bike travel times
...
//		Map<Integer, Double> otherTimesDelta = new HashMap<Integer, Double>();
		...
		// transient at the beginning of the MATSim simulation must not be considered for steady-state stability assessment
		Integer notConsideredTransientIterNumber = Integer.parseInt(args[2]);
		// certain deviations are regarded over an interval of iterations --> specify the size with the fourth argument
...
//				System.out.println("lastIterationAvailable = "+lastIterationAvailable);
		...
		// the above defined parameters are evaluated by three different deviations
		// 1. standard deviation per definition
		// 2. average deviation from the average over all iterations
		// 3. a moving standard deviation of the last 30 iterations
...
//		System.out.println("Travel Times Pt = "+ptTimeStdDevs.toString());
		...
		// to better compare the deviations we calculate the 90th percentile interval for certain parameters
