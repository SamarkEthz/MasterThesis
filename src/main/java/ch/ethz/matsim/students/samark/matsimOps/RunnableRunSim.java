...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/* 
* This class has the same task and architecture as the run method in NetworkEvolutionRunSim.
* It is used only when threading is activated.
* See NetworkEvolutionRunSim for details.
*/
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
public class RunnableRunSim implements Runnable {
	...
	// See run method in NetworkEvolutionRunSim for details.
	public void run() {
			try {
				Log.write("  >> Running MATSim simulation (over Runnable) on:  "+this.mNetwork.networkID);
			} catch (IOException e) {
				e.printStackTrace();
			}
...
//		new NetworkWriter(modScenario.getNetwork()).write(simulationPath+"/output_network_backup.xml.gz");
//		new TransitScheduleWriter(modScenario.getTransitSchedule()).writeFile(simulationPath+"/output_transitSchedule_backup.xml.gz");
