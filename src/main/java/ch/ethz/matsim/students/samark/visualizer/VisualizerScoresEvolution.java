...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/* 
* This class is intended to plot the evolution of the scores of the best network in each generation (the best network may obviously change with gen's)
*/
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DESCRIPTION   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
public class VisualizerScoresEvolution {
	...
	public static void main(String[] args) throws IOException {
		...
		// for each generation analyze the averaged network cbp file (global)
		for (int gen=1; gen<=finalGen; gen++) {
			...
			// go through each MNetwork of this gen --> find one with highest score and calculate average score
			...
			if (betterValueFound) {
				// extract and write the parameters of the best network in this gen
